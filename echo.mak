...
#
# Toolchain: TASKING Tools for 68K/ColdFire v10.0 r4
#

PROJ    = echo
PROJDIR = z:\documents\ede\dev5213cf
PRODDIR = c:\program files\tasking\c68k v10.0
...
OPT_LK  = -L "$(PRODDIR)\rtlibs\lib5206e\lib\lib5206e" -c "z:\documents\ede\dev5213cf\m5213.lc"
OPT_OP  = -d  abs
OPT_XVW = -tcfg "bdmcf.cfg" -D dev,usb1 -C 5213 -i --load_application_download=true --load_application_signal=true --load_application_program_reset=true --load_application_target_reset=false --load_application_goto_main=true -T "z:\documents\ede\dev5213cf\m5213.cmd" -b 16 -a 16 -s 26
